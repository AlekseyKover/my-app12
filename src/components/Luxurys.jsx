    ...
    <section className="luxury">
      <div className="luxury__block">
        <div className="luxury__text">
          <h2 className="luxury__name">
            Истинная роскошь должна быть элегантной
          </h2>
          <p className="luxury__subbtitle">
            ...
            на рассвете под первыми лучами солнца, или тех, кто к полудню решит
            понежиться на солнышке. Ваш вечер пролетит незаметно за уютными
            разговорами на свежем воздухе, а зимой терраса превратится
            в собственный каток для жителей и их гостей.
          </p>
        </div>
