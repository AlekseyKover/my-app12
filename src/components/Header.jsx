    ...
    return (
        <header className="header">
            <div className="header_title"> 
               <img src={logo} className="header_logo"></img>
                <nav className="header_titleInfo1">
                    ...
                    <li className="header_text"><a href="#"></a>О проекте</li>
                    <li className="header_text"><a href="#"></a>Предложения</li>
                    <li className="header_text"><a href="#"></a>Контакты</li>
            ...
            <div className="section__title"> 
                    ...
                    <h3 className="section__subbtitleText">Пресненский район, ул. Климашкина, 16</h3>
